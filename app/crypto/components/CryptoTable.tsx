...
export default function CryptoTable({ coins, loading, onSelectCoin, rtPrices = {} }: CryptoTableProps) {
  const { favorites, addFavorite, removeFavorite, viewMode } = useCryptoStore();
  ...
  const handleFavorite = (coinId: string, e: MouseEvent<HTMLButtonElement>) => {
    e.stopPropagation();
            ...
            >
              ...
              <div className="card-body">
                <div className="price-row">
                  ...
                  <LivePrice price={rtPrices[coin.id] ?? coin.current_price} className="value" />
                </div>
                ...
                <td>
                  <div className="coin-cell">
                    ...
                    <div className="coin-details">
                      ...
                      <LivePrice price={rtPrices[coin.id] ?? coin.current_price} showDirection={false} className="coin-price-mobile" />
                    </div>
                  </div>
                </td>
                <td className="text-right font-semibold">
                  <LivePrice price={rtPrices[coin.id] ?? coin.current_price} />
                </td>
